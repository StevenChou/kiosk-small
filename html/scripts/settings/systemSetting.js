    ...
    kiosk.wording = {
      ...
      1: {
        ...
        remind: {
          ...
          remindTitle3:
            'Please prepare your travel document (passport / exist & entry permit) and your invoices for tax refund application, then click "Start."',
          btTitle: 'Start',
      ...
      5: {
        ...
        scanPassport: {
          ...
          scanError:
            'ไม่สามารถระบุได้ โปรดสแกนหนังสือเดินทางของคุณใหม่อีกครั้ง',
          toError: 'error',
          toPreScanQR: 'preScanQRcode',
          scanPassportLoading:
      ...
      7: {
        ...
        scanQRcode: {
          scanQRcodeTitle1:
            'Escanee el código de barras de su factura de compra',
        ...
        success: {
          ...
          successTitle2:
            'Acuda al mostrador Nº 2 para comprobar los documentos',
          successTitle3:
      ...
      10: {
        ...
        scanQRcode: {
          ...
          scanQRErrorDup:
            'Hóa đơn bị lặp lại.<br>Vui lòng quét trang tiếp theo',
          scanQRcodeLoading:
